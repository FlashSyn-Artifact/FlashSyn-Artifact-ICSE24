...
'''
    ...
    def initialPass(cls):
        ...
        action_list_1 = [action3]


        action3_prestate_dependency = [action1, action2, action4, action5]
...
class PancakePairSkim(WdogeAction):
    ...
    def collectorStr(cls):
        ...
        action += '''        str1 = PancakePairSummary();
        uint WdogeGot = wdoge.balanceOf(address(this));

        wdoge_wbnb_pair.skim(address(this)); 
    ...
    @classmethod
    def simulate(cls):
        inputs = [cls.globalStates[0], cls.globalStates[2]]
...
# Test for initial pass of data collecton: 
    WdogeAction.initialPass()
    # WdogeAction.runinitialPass()
